...
public class NewsImagesPagerAdapter extends PagerAdapter {
    ...
    public NewsImagesPagerAdapter(Context context, int posForCache,  ArrayList<String> imagesArr) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        final String path = context.getCacheDir() + "/" + "news_preview"  + "_" + AppSingleton.getInstance().currentQR+"_"+ position + "_"+posForCache+ ".png";
