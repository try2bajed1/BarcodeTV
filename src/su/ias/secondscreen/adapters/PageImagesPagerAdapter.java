...
public class PageImagesPagerAdapter extends PagerAdapter {
    ...
    public PageImagesPagerAdapter(Context context, int posForCache, ArrayList<String> imagesArr) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        final String path = context.getCacheDir() + "/" + "page_slide_preview"  + "_" + position + "_"+posForCache+ ".png";
